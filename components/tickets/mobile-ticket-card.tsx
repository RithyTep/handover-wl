...
const themeStyles: Record<string, Record<string, string>> = {
	...
	header: {
		...
		pchum_ben: "border-[#d4af37]/40 bg-[#1a0a24]/95",
	...
	ticketLink: {
		...
		pchum_ben: "text-[#e8b64c] hover:text-[#f5d78a]",
	...
	avatarPlaceholder: {
		...
		pchum_ben: "bg-[#2a1233] text-[#e8b64c] font-bold",
