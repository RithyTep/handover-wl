...
const themeStyles: Record<string, Record<string, string>> = {
	card: {
		...
		pchum_ben: "border-violet-950/50 pchum-card",
	...
	header: {
		...
		pchum_ben: "border-violet-950/50 bg-[#181026]/70",
	...
	ticketLink: {
		...
		pchum_ben: "text-amber-300 hover:text-amber-200",
	...
	avatarPlaceholder: {
		...
		pchum_ben: "bg-violet-950/60 text-amber-300",
