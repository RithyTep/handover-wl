...
import { generateChallenge, hashRequestBody, validatePoWSolution } from './pow'
import { hashFingerprint, isValidFingerprintFormat, validateFingerprint } from './fingerprint'
...
function getJwtSecret(): Uint8Array {
  ...
  if (!secret) {
    console.warn('JWT secret not configured', { env: JWT_SECRET_ENV })
