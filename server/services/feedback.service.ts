...
export class FeedbackService {
	...
	async getAllItems(limit: number = DEFAULT_LIMIT): Promise<IFeedbackItem[]> {
	...
	toItem(feedback: Feedback): IFeedbackItem {
		return {
			...
			created_at: feedback.created_at instanceof Date ? feedback.created_at.toISOString() : String(feedback.created_at),
